...
const Chat = () => {
  ...
  return (
    <div className="w-full min-h-screen p-4 mx-auto bg-gray-800">
      ...
      <div className="max-w-2xl p-4 mx-auto mb-4 rounded-lg shadow-md bg-gray-950 bg-opacity-80">
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col items-center space-y-2 sm:flex-row sm:space-y-0 sm:space-x-2">
          <input
            type="text"
            {...register('message', { required: true })}
            className="flex-1 w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500"
            placeholder="Say something..."
          />
          <button type="submit" className="w-full px-4 py-2 text-white bg-blue-600 rounded-lg sm:w-auto hover:bg-blue-700">Send</button>
        </form>
      </div>
