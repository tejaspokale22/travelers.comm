...
function ViewResponse() {
  ...
  return (
    <div className="flex flex-col min-h-screen text-white bg-gray-900">
      <main className="flex flex-col items-center flex-1 w-full p-4 mx-auto bg-gray-800 rounded-lg shadow-lg sm:p-6">
        <h2 className="mb-4 text-2xl font-bold text-center sm:text-3xl">{response.touristPlaceName}</h2>
        <div className="flex flex-col w-full p-4 space-y-4 text-left bg-gray-700 rounded-lg sm:w-3/4 lg:w-1/2">
        ...
        {images.length > 0 && (
          <div className="w-full mt-8">
            <h3 className="mb-4 text-xl font-semibold sm:text-2xl">Gallery:</h3>
              ...
              {imageViewUrls.map((url, index) => (
                ...
                >
                  <img
                    ...
                    className="object-cover w-full h-24 rounded-md sm:h-36 md:h-48 lg:h-64"
                  />
                </div>
              ))}
            </div>
      ...
      {selectedImage && (
        ...
        >
          <div
            className="relative max-w-full max-h-screen p-4 bg-white rounded-lg"
